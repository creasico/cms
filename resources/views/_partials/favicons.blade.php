<link rel="apple-touch-icon" sizes="57x57" href="{{ asset_url('images/favicons/mobile-icon-57x57.png') }}">
<link rel="apple-touch-icon" sizes="60x60" href="{{ asset_url('images/favicons/mobile-icon-60x60.png') }}">
<link rel="apple-touch-icon" sizes="72x72" href="{{ asset_url('images/favicons/mobile-icon-72x72.png') }}">
<link rel="apple-touch-icon" sizes="76x76" href="{{ asset_url('images/favicons/mobile-icon-76x76.png') }}">
<link rel="apple-touch-icon" sizes="114x114" href="{{ asset_url('images/favicons/mobile-icon-114x114.png') }}">
